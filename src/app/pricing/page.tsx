      ...
      <main className="relative z-10 pt-24 pb-20 min-h-screen">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="relative rounded-2xl border border-white/[0.06] bg-[#0f141c]/80 backdrop-blur-sm overflow-hidden"
          >
            {/* Accent top line */}
            ...
            <div className="p-8 md:p-10">
              <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2.5 rounded-none bg-[#27496D] px-8 py-3.5 text-base text-white shadow-none hover:bg-[#27496D] transition-all hover:-translate-y-0.5 active:translate-y-0 shrink-0"
                >
                  Get Access
