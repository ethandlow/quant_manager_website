...
function StarIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-[#f6c94c] shrink-0" aria-hidden>
    ...
    <section className="relative z-10 py-24 md:py-32 overflow-hidden">
      <div className="mx-auto max-w-4xl px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Card — fixed height prevents layout shift when review length changes */}
          <div className="h-[320px] sm:h-[300px] md:h-[280px] flex flex-col">
            <AnimatePresence mode="wait" initial={false}>
              <motion.div
                ...
                className="rounded-2xl border border-white/[0.06] bg-[#0f141c]/60 backdrop-blur-sm p-8 md:p-10 text-center h-full flex flex-col items-center justify-center"
              >
                {/* Stars */}
